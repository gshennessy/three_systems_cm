...
analyses presented in three studies led by Bond\citep{2017ApJ...840...70B,2015ApJ...813..106B,2020ApJ...904..112B}. In
each case, the analysis relied on measurements of relative position angles and separations between the binary components
rather than absolute right ascension and declination. Consequently, the derived quantities are insensitive to telescope
pointing errors, provided that both components remain well within the detector field of view. 
